...
import 'package:practice/search/model.dart';
...
class _DemoAppState extends State<DemoApp> {
  List<SearchItem> _data = generateItems(20);
  ...
  final List<Map<String, Object>> _searchItem = [
...
List<SearchItem> generateItems(int numberOfItems) {
