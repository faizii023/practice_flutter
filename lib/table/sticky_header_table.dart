...
class StickyHeaderTablePage extends StatefulWidget {
  const StickyHeaderTablePage({Key? key}) : super(key: key);
  final columns = 10;
  final rows = 20;
  ...
  @override
  State<StickyHeaderTablePage> createState() => _StickyHeaderTablePageState();
}

class _StickyHeaderTablePageState extends State<StickyHeaderTablePage> {
